...
if("TRUE" STREQUAL "TRUE")
  set(traj_gen_SOURCE_PREFIX /home/jbs/test_ws/src/traj_gen)
  set(traj_gen_DEVEL_PREFIX /home/jbs/test_ws/src/traj_gen/cmake-build-debug/devel)
...
if(NOT "/home/jbs/test_ws/src/traj_gen/cmake-build-debug/devel/include;/home/jbs/test_ws/src/traj_gen/include " STREQUAL " ")
  set(traj_gen_INCLUDE_DIRS "")
  set(_include_dirs "/home/jbs/test_ws/src/traj_gen/cmake-build-debug/devel/include;/home/jbs/test_ws/src/traj_gen/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'traj_gen' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jbs/test_ws/src/traj_gen/${idir}'.  ${_report}")
    endif()
    _list_append_unique(traj_gen_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "traj_gen")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT traj_gen_NUM_DUMMY_TARGETS)
      set(traj_gen_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::traj_gen::wrapped-linker-option${traj_gen_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR traj_gen_NUM_DUMMY_TARGETS "${traj_gen_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::traj_gen::wrapped-linker-option${traj_gen_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND traj_gen_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jbs/test_ws/src/traj_gen/cmake-build-debug/devel/lib;/home/jbs/test_ws/devel/lib;/home/jbs/vin_ws/devel/lib;/opt/ros/melodic/lib)
