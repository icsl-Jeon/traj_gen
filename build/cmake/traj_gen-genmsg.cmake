...
add_custom_target(_traj_gen_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "traj_gen" "/home/jbs/catkin_ws/src/traj_gen/msg/PolySplineXYZ.msg" "traj_gen/PolySpline:traj_gen/PolyCoeff"
)

get_filename_component(_filename "/home/jbs/catkin_ws/src/traj_gen/msg/PolyCoeff.msg" NAME_WE)
add_custom_target(_traj_gen_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "traj_gen" "/home/jbs/catkin_ws/src/traj_gen/msg/PolyCoeff.msg" ""
)
...
_generate_msg_cpp(traj_gen
  ...
  "${MSG_I_FLAGS}"
  "/home/jbs/catkin_ws/src/traj_gen/msg/PolySpline.msg;/home/jbs/catkin_ws/src/traj_gen/msg/PolyCoeff.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/traj_gen
)
_generate_msg_cpp(traj_gen
  "/home/jbs/catkin_ws/src/traj_gen/msg/PolyCoeff.msg"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/traj_gen)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/traj_gen\")")
  # install generated code
  install(
